...
namespace MMBLauncher
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)//When Form first loads up
        {
            ...
            client1.DownloadFile("https://raw.githubusercontent.com/Ender-MCBE/DylansEpicMMBLauncher/main/news.txt", "Files/news.txt");
            client1.DownloadFile("https://raw.githubusercontent.com/Ender-MCBE/DylansEpicMMBLauncher/main/background.png", "Files/background.png");
            client1.DownloadFile("https://raw.githubusercontent.com/Ender-MCBE/DylansEpicMMBLauncher/main/version.txt", "Files/version.txt");
            using (System.IO.StreamReader file = new System.IO.StreamReader("Files/news.txt"))
            {
                string News = file.ReadToEnd();
                richTextBox1.Text = News;
            }
            this.BackgroundImage = new Bitmap("Files/background.png");
        }
        ...
        void client_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            //downloading, extract the file.
            label1.Invoke(DownloadComplete);
            label1.Invoke(ExtractingFiles);
            progressBar1.Invoke(Upgrade);
            //Directory.Delete("Files/Core/Data", true);
            File.Delete("Core/MMB.exe");
            try
            {
                ZipFile.ExtractToDirectory("Update.zip", "Core/");
            }
            catch {};
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (System.IO.StreamReader file = new System.IO.StreamReader("Files/version.txt"))
                {
                ...
                if (button1.Text == "Check")
                {
                    ...
                    //client2.DownloadFile("https://raw.githubusercontent.com/Ender-MCBE/DylansEpicMMBLauncher/main/version.txt", "Files/version.txt");
                    using (System.IO.StreamReader file = new System.IO.StreamReader("Files/version.txt"))
                    {
                ...
                else if (button1.Text == "Launch")
                {
                    Process.Start(@"Core\MMB.exe");
                    this.Close();
                }
            }
            else 
        ...
        public void Updater() //Thread to make Updater Run smoothly
        {
            ...
            if (VerisonNumber > CurrentVerisonNumber)
            {
                ...
                client3.DownloadFileAsync(new Uri("https://raw.githubusercontent.com/Ender-MCBE/DylansEpicMMBLauncher/main/client.zip"), "Update.zip");
            }
